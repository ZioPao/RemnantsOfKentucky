...
InsertSpawnpoint("EASTERN SHORE SPAWN #1", 848, 445, 0)
InsertSpawnpoint("EASTERN SHORE SPAWN #2", 870, 356, 0)
InsertSpawnpoint("EASTERN SHORE SPAWN #3", 563, 120, 0)
InsertSpawnpoint("WESTERN SHORE SPAWN #1", 29, 412, 0)
InsertSpawnpoint("WESTERN SHORE SPAWN #2", 57, 331, 0)
InsertSpawnpoint("WESTERN SHORE SPAWN #3", 149, 231, 0)
InsertSpawnpoint("NORTHERN SHORE SPAWN #1", 575, 120, 0)
InsertSpawnpoint("NORTHERN SHORE SPAWN #2", 369, 62, 0)
InsertSpawnpoint("NORTHERN SHORE SPAWN #3", 278, 26, 0)
InsertSpawnpoint("SOUTH EAST RADIO TOWER SPAWN", 715, 503, 0)
